...
function parsePlace(raw, index) {
  ...
  return {
    ...
    lat: originCoord.lat,
    lon: originCoord.lon,
    anyStop: raw.anyStop === true && originCoord.lat !== null && originCoord.lon !== null,
    ...
    destAnyStop: hasDestination && raw.destAnyStop === true && destCoord.lat !== null && destCoord.lon !== null,
